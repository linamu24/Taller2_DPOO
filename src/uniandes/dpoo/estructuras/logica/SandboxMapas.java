...
public class SandboxMapas
{
    ...
    {	
    	...
    	String cadena=Collections.min(mapaCadenas.keySet());
    ...
    public String getUltima( )
    {
    	...
    	String cadena=Collections.max(mapaCadenas.values());
    ...
    public Collection<String> getLlaves( )
    {
    	...
    	for (String llave:llaves) {
    		...
    		mayusculas.addLast(llave.toUpperCase());
    	}
    ...
    {
    	ArrayList<String> listaDif=new ArrayList<String>( );
    	ArrayList<String> valores=new ArrayList<String>(mapaCadenas.values() );
    	
    	for (String valor:valores) {
    		if(listaDif.contains(valor)!=true) {
    			listaDif.add(valor);
    		}
    	}
    	
        return listaDif.size();
    }
    ...
    public void agregarCadena( String cadena )
    {
    	...
    	String inversa= c.reverse().toString();
    	mapaCadenas.put(inversa,cadena);
